libs <- list('terra', 'tidyverse', 'ggcorrplot', 'leaps', 'gridExtra')
invisible(lapply(libs, library, character.only = T))

# Set wd
setwd("C:/Users/alegb/OneDrive/Documents/SPEC_School/StationC")
# load the data
...
# display the data
plot(agb, main = "Mountain Lake Aboveground Biomass")
plot(plots, add = T)
